...
<body>
    ...
    <nav class="navbar navbar-expand-lg navbar-dark bg-dark">
        ...
        <div class="collapse navbar-collapse " id="navbarNavAltMarkup">
            <div class="navbar-nav">
                <a class="nav-item nav-link active" href="./index.php">Practical slot <span
    ...
    <section class="container">
        <h1 class="text-dark mt-2"> COMP207 - Register here for a practical slot</h1>
        ...
        <ul class="text-capitalize">
            ...
            <li>
                Any problems? write a message to weberb@csc.liv.ac.uk
            </li>
        </ul>
            ...
            <div class="row mt-3">
                ...
                <div class="col-3">
                    ...
                    <div class="input-group-prepend">
                        ...
                        <input type="number" class="form-control" id="sid" name="sid" placeholder="your student Id"
                            required>
                    </div>
                </div>
                <div class="col-3">
